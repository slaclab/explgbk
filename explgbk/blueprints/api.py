...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/add_update_experiment_params", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("manage_groups")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/migrate_attachments", methods=["GET", "POST"]
)
@context.security.authentication_required
@context.security.authorization_required("experiment_delete")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/ext_preview/<path:path>", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/elog/<entry_id>/complete_elog_tree", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/modify_elog_entry", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("edit")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/delete_elog_entry", methods=["DELETE"]
)
@context.security.authentication_required
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/elog_email_subscriptions", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/elog_email_subscribe", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/elog_email_unsubscribe", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_instrument_elogs", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/file_counts_by_extension", methods=["GET"]
)
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/<run_num>/files_for_live_mode", methods=["GET"]
)
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/files_for_live_mode_at_location", methods=["GET"]
)
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/run_table_sources", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/create_update_user_run_table_def", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/run_table_editable_update", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/clone_run_table_def", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/replace_system_run_table_def", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/clone_system_template_run_tables", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/delete_run_table", methods=["DELETE"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/runtables/export_as_csv", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/run_control/<experiment_name>/ws/start_run", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/run_control/<experiment_name>/ws/end_run", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/run_control/<experiment_name>/ws/current_run", methods=["GET"]
)
...
@explgbk_blueprint.route(
    "/run_control/<experiment_name>/ws/add_run_params", methods=["POST"]
)
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/close_shift", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/create_update_shift", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/samples/<sampleid>", methods=["PUT"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/samples/<sample_name>", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/samples/<sample_name>", methods=["DELETE"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("edit")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/current_sample_name", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/clone_sample", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/make_sample_current", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/stop_current_sample", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/change_sample_for_run", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists_and_unlocked
@context.security.authorization_required("edit")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/file_available_at_location", methods=["GET", "POST"]
)
@context.security.authentication_required
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/check_and_move_run_files_to_location",
    methods=["GET", "POST"],
)
@context.security.authentication_required
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/exp_posix_group_members", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/toggle_role", methods=["GET", "POST"]
)
@experiment_exists
@context.security.authentication_required
@context.security.authorization_required("manage_groups")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/add_collaborator", methods=["GET", "POST"]
)
@experiment_exists
@context.security.authentication_required
@context.security.authorization_required("manage_groups")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/remove_collaborator", methods=["GET", "POST"]
)
@experiment_exists
@context.security.authentication_required
@context.security.authorization_required("manage_groups")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/sync_collaborators_with_user_portal", methods=["GET"]
)
@experiment_exists
@context.security.authentication_required
@context.security.authorization_required("edit")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_modal_param_definitions", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_feedback_document", methods=["GET"]
)
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/add_feedback_item", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_run_params_for_all_runs", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_runs_matching_params", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_runs_matching_editable", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/get_runs_with_tag", methods=["GET"]
)
@experiment_exists
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/<run_num>/get_tags_for_run", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/map_param_editable_to_run_nums", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/workflow_definitions", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/workflow_triggers", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/create_update_workflow_def", methods=["POST"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/workflow_definitions/<defid>", methods=["DELETE"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/workflow/<job_id>/<path:action>", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/create_workflow_job", methods=["POST"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/delete_workflow_job", methods=["GET", "POST"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/update_workflow_job", methods=["POST"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/kill_workflow_job", methods=["GET", "POST"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/generate_arp_token", methods=["GET"]
)
@context.security.authentication_required
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/run_param_descriptions", methods=["GET"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("read")
...
@explgbk_blueprint.route(
    "/run_control/<experiment_name>/ws/add_update_run_param_descriptions",
    methods=["POST"],
)
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/add_update_run_param_descriptions", methods=["POST"]
)
@context.security.authentication_required
@experiment_exists
@context.security.authorization_required("post")
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/<run_num>/get_params_matching_prefix", methods=["GET"]
)
...
@explgbk_blueprint.route(
    "/lgbk/<experiment_name>/ws/<run_num>/daq_run_params", methods=["GET"]
)
...
@explgbk_blueprint.route(
    "/lgbk/ws/projects/<prjid>/grids/<gridid>/linksession", methods=["GET"]
)
@user_in_project
