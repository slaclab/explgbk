...
from app.models.v2.db import LogbookEntry
from app.models.v2.schemas import EntryRevisionCreate, LogbookCreate
from tests.sql.helpers import make_entry, make_logbook
...
def test_get_logbook(session: Session) -> None:
...
def test_create_entry_revision(session: Session) -> None:
    entry = make_entry(session)
...
def test_get_entry_revisions_ordered(session: Session) -> None:
...
def test_entry_revision_tag_snapshot(session: Session) -> None:
